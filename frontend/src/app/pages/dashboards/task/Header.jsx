      ...
      <header className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Input
            ...
            classNames={{ root: "max-md:hidden", input: "h-8 text-xs-plus" }}
          ...
          <div className="flex">
            ...
            <Button variant={searchQuery.order_by == 'modified asc' ? "soft" : "flat"} isIcon className="size-8" onClick={() => setSearchQuery({ ...searchQuery, order_by: 'modified desc' })}>
              <ArrowsUpDownIcon className="size-4.5" />
            </Button>
            <Button variant={searchQuery.order_by == 'modified desc' ? "soft" : "flat"} isIcon className="size-8" onClick={() => setSearchQuery({ ...searchQuery, order_by: 'modified asc' })}>
