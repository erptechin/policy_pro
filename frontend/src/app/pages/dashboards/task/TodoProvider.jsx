...
const initialState = {
  ...
  todos: [],
  doctype: "Task",
  fields: ['name', 'subject', "status", 'project', 'priority', 'exp_start_date', 'exp_end_date', 'expected_time', 'progress', 'description'],
  searchQuery: { subject: "", status: "Open", priority: "Low" },
  error: null,
};
...
const reducerHandlers = {
  ...
  [ACTIONS.SET_INFOS]: (state, payload) => ({
    ...state,
    infos: payload,
  }),
...
export function TodoProvider({ children }) {
  ...
  const { infos, doctype, fields, todos, searchQuery, error } = state;
  ...
  const setInfo = useCallback((query) => {
    dispatch({ type: ACTIONS.SET_INFOS, payload: query });
  }, []);
