...
const initialState = {
  infos: [],
  doctype: "Opportunity",
  fields: ['name', 'title', "source", 'opportunity_type', 'status'],
  searchQuery: { title: "", source: "", opportunity_type: "Sales" },
  boards: fakeBoards,
...
export function BoardProvider({ children }) {
  ...
  const [{ infos, doctype, fields, searchQuery, boards, activeBoardId, lastMoved }, dispatch] = useReducer(
    boardReducer,
    initialState,
  );
